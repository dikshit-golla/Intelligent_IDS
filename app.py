...
def index():
    # page now only contains a CSV upload form
...
def predict():
    ...
    # When a file is provided, read it and make predictions for each row.
    ...
    # Determine final SHAP array for binary classification
    ...
    for i, row in input_df.iterrows():
        ...
        # Generate AI summary for this row
